...
const NavBar = () => {
  ...
  const navItems = [
    ...
    { name: 'Resume', href: '/Marta_Resume_2025.pdf', download: true },
  ];
  ...
  return (
    <>
      ...
      <nav className="hidden md:flex fixed top-0 left-0 h-screen w-64 flex-col gap-4 bg-background bg-opacity-50 backdrop-blur-lg p-4 z-50">
        {/* Brand Name */}
        ...
        <div className="mt-auto flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <a
              ...
              className="flex items-center p-2 rounded text-inverse hover-inverse transition-colors w-fit"
              aria-label="Email"
            >
              <svg
                width="24"
          ...
          <button
            onClick={toggleTheme}
            className="flex items-center rounded text-inverse transition-colors w-fit"
            aria-label="Toggle theme"
          >
            <span className="inline-flex p-1 rounded hover-inverse">
              <svg
                width="24"
                height="24"
                stroke="currentColor"
      ...
      {/* Mobile Navigation */}
      <nav className="md:hidden fixed top-0 z-50 w-full flex gap-4 bg-background bg-opacity-50 backdrop-blur-lg p-3">
        {/* Brand Name */}
        ...
        <div className="flex items-center">
          <button
            type="button"
            className="flex items-center gap-2 p-2 rounded text-inverse hover-inverse transition-colors"
            onClick={toggleMenu}
